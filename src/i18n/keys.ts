...
export type I18nKey =
  ...
  | 'project.tab.selections'
  | 'project.tab.daily_log'
  | 'project.tab.notes'
  | 'project.tab.portal'
  | 'project.brain.next_action'
  | 'project.brain.crew_on_site'
  | 'project.brain.open_items'
  | 'project.brain.last_capture'
  | 'project.panel.overview'
  | 'project.panel.selections'
  | 'project.panel.daily_log'
  | 'project.panel.notes'
  | 'project.panel.portal'
  | 'project.overview.link_camera'
  | 'project.overview.link_portal'
  | 'project.overview.link_schedule'
  | 'project.overview.link_subs'
  | 'project.overview.assignments'
  | 'project.selections.empty'
  | 'project.daily_log.loading'
  | 'project.daily_log.link_camera'
  | 'project.daily_log.link_voice'
  | 'project.daily_log.view'
  | 'project.notes.empty'
  | 'project.portal.gc_preview'
  | 'project.portal.client_login_hint'
  | 'project.portal.preview_title'
  | 'project.portal.preview_subtitle'
  | 'project.portal.loading'
  | 'project.wo.sent'
  | 'project.wo.draft'
  | 'schedule.assignment_centric'
  | 'schedule.events_title'
  | 'schedule.loading'
  | 'schedule.link_subs'
  | 'team_ops.subs.title'
  | 'team_ops.subs.subtitle'
  | 'project.detail.back'
  ...
  | 'login.unavailable'
  | 'platform.on_me.nav'
  | 'platform.on_me.title'
  | 'platform.on_me.subtitle'
  | 'platform.on_me.empty'
  | 'platform.home.stub_title'
  | 'platform.home.stub_body'
  | 'shell.role_switcher.aria'
  | 'shell.conversation.aria'
  | 'shell.conversation.desktop_title'
  | 'shell.conversation.hint'
  | 'shell.conversation.placeholder'
  | 'shell.conversation.input_label'
  | 'shell.conversation.import'
  | 'shell.conversation.talk'
  | 'shell.conversation.capture'
  | 'shell.conversation.send'
  | 'shell.conversation.meta'
  | 'shell.conversation.split_label'
  | 'shell.conversation.proof_label'
  | 'shell.conversation.proof_saved'
  | 'shell.conversation.proof_review'
  | 'shell.conversation.proof_gate'
  | 'home.loops.aria'
  | 'home.loops.heading'
  ...
  | 'shell.more.title'
  | 'shell.more.lead'
  | 'shell.more.domains_eyebrow'
  | 'shell.more.domains_title'
  | 'shell.more.domains_copy'
  | 'shell.more.domains_aria'
  | 'shell.more.quick_eyebrow'
  | 'shell.more.quick_title'
  | 'shell.more.schedule_detail'
  | 'shell.more.reports_detail'
  | 'shell.more.settings_detail'
  | 'shell.domain.home'
  | 'shell.domain.sales'
  | 'shell.domain.clients'
  | 'shell.domain.projects'
  | 'shell.domain.field'
  | 'shell.domain.schedule'
  | 'shell.domain.money'
  | 'shell.domain.people_admin_ops'
  | 'shell.domain.client_success'
  | 'right_hand.title'
  | 'right_hand.eyebrow'
  | 'right_hand.lead'
  ...
  | 'f_cl5.tab.comms'
  | 'f_cp.preview_title'
  | 'f_cp.preview_subtitle'
  | 'f_cp.preview_link'
  | 'f_cp.gc_banner'
  | 'f_cp.open_client_login'
  | 'f_cs.list_title'
  | 'f_cs.list_subtitle'
  | 'f_cs.detail_title'
  | 'f_cs.link'
