...
export const WIREFRAME_SPINE_MAP: readonly WireframeSpineEntry[] = [
  ...
  },
  {
    ...
    next: [
      ...
      { trigger: 'Connections', route: '/connections', face: 'F-SP1_desktop_settings.html' },
      { trigger: 'Project audit', route: '/audit/:packetId', face: 'F-H1_desktop_audit_detail.html' },
    ],
  },
  {
  ...
  },
  {
    ...
    wireframes: ['F-SP1_desktop_settings.html'],
    status: 'missing_canon_face',
    notes: 'Connections is a settings subface; no dedicated canon file in repo.',
    next: [
      { trigger: 'Back settings', route: '/settings', face: 'F-SP1_desktop_settings.html' },
    ],
  },
  ...
  },
  {
    ...
    next: [
      ...
      { trigger: 'Blackboard', route: '/blackboard', face: 'missing canon face' },
      { trigger: 'Cost KB', route: '/kb-ingestion', face: 'missing canon face' },
  ...
  },
  {
    ...
    wireframes: [],
    status: 'stub_or_holding',
    notes: 'Registered holding route with no canon face.',
    next: [
      { trigger: 'Knowledge item', route: '/kb-ingestion/:id', face: 'missing canon face' },
    ],
  },
  {
    ...
    wireframes: [],
    status: 'stub_or_holding',
    notes: 'Detail holding route with no canon face.',
    next: [
      { trigger: 'Back KB', route: '/kb-ingestion', face: 'missing canon face' },
      { trigger: 'Projects', route: '/projects', face: 'F-PR1_mobile_projects_list.html' },
  ...
  },
  {
    ...
    wireframes: [],
    status: 'stub_or_holding',
    notes: 'Registered honest stub route; no canon face in repo.',
    next: [
