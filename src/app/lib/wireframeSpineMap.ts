...
export const WIREFRAME_SPINE_MAP: readonly WireframeSpineEntry[] = [
  ...
  },
  {
    ...
    next: [
      ...
      { trigger: 'Create down-payment invoice', route: '/estimate/:projectId/invoice', face: 'per-job invoice face missing from repo' },
    ],
  },
  {
    ...
    status: 'missing_canon_face',
    notes: 'User canon calls for invoice list per job with deposit/progress/final. Dedicated per-job invoice face is missing from repo.',
    next: [
      { trigger: 'Back estimate', route: '/estimate/:projectId', face: 'F-EST1_mobile_estimate_builder.html' },
