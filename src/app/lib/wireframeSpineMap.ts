...
export const WIREFRAME_SPINE_MAP: readonly WireframeSpineEntry[] = [
  ...
  },
  {
    ...
    status: 'canon_wired',
    notes: 'F-PR0 project setup is wired as an operator-confirmed graph write from client, sales, voice, or capture routing. No money/send/proposal consequence happens here.',
    next: [
      { trigger: 'Cancel', route: '/projects or /clients/:id', face: 'F-PR1_mobile_projects_list.html' },
      { trigger: 'Create project', route: '/projects/:id', face: 'F-PR2_mobile_project_detail.html' },
      { trigger: 'Create + build estimate', route: '/estimate/:projectId', face: 'F-EST1_mobile_estimate_builder.html' },
      { trigger: 'Create + file capture', route: '/projects/:id/daily-log', face: 'F-DL1_mobile_daily_log.html' },
    ],
  },
  {
    route: '/projects/:id',
  ...
  },
  {
    ...
    status: 'canon_wired',
    notes: 'F-DES1a/F-DS1 design workspace is wired as the review-gated bridge from deal detail to estimate. Selection pull/approval stays behind explicit review confirmation.',
    next: [
      { trigger: 'Deal back', route: '/sales/:id', face: 'F-SL3_mobile_deal_detail.html' },
      { trigger: 'Open KB', route: '/library', face: 'F-LIB1_desktop_libraries_selections.html' },
  ...
  },
  {
    ...
    status: 'canon_wired',
    notes: 'F-EST1 estimate builder is wired on the estimate branch. It preserves proposal/invoice line_id carry and keeps publish/proposal actions operator-confirmed.',
    next: [
  ...
  },
  {
    ...
    domain: 'money',
    surface: 'Per-job invoice list',
    wireframes: ['F-INV1a_mobile_per_job_invoice_list.html', 'F-INV1b_desktop_per_job_invoice_list.html'],
    status: 'canon_wired',
    notes: 'Per-job invoice list route owns the invoice set and drills into detail. It preserves line_id carry and leaves issue/send/payment/export behind the Money guard.',
    next: [
      { trigger: 'Back estimate', route: '/estimate/:projectId', face: 'F-EST1_mobile_estimate_builder.html' },
      { trigger: 'Back proposal', route: '/estimate/:projectId/proposal', face: 'F-PV1_mobile_proposal_view.html' },
      { trigger: 'Open Money', route: '/estimate/:projectId/money', face: 'F-MN1_mobile_money_home.html' },
      { trigger: 'Open invoice detail', route: '/estimate/:projectId/invoice/:invoiceId', face: 'F-INV2a_mobile_per_job_invoice_detail.html' },
    ],
  },
  {
    route: '/estimate/:projectId/invoice/:invoiceId',
    appFile: 'src/app/pages/estimate/[projectId]/invoice/[invoiceId].astro',
    domain: 'money',
    surface: 'Per-job invoice detail',
    wireframes: ['F-INV2a_mobile_per_job_invoice_detail.html', 'F-INV2b_desktop_per_job_invoice_detail.html'],
    status: 'canon_wired',
    notes: 'Invoice detail drills into one milestone invoice, previews the client copy, carries line_ids, and routes issue/payment consequences back to Money.',
    next: [
      { trigger: 'Back invoice list', route: '/estimate/:projectId/invoice', face: 'F-INV1a_mobile_per_job_invoice_list.html' },
      { trigger: 'Issue in Money', route: '/estimate/:projectId/money', face: 'F-MN1_mobile_money_home.html' },
      { trigger: 'Preview client copy', route: '/api/v1/right-hand/estimates/:id/invoice', face: 'print artifact, invoice projection' },
    ],
  },
  {
  ...
  },
  {
    ...
    status: 'canon_wired',
    notes: 'F-CL0 client create is wired as an operator-confirmed client graph write. It can continue to project setup or intake holding without silently creating a project.',
    next: [
      { trigger: 'Cancel', route: '/clients', face: 'F-CL1_mobile_clients_list.html' },
      { trigger: 'Save client', route: '/clients/:id', face: 'F-CL5_mobile_client_record.html' },
      { trigger: 'Save + add project', route: '/projects/new?client_id=:id', face: 'F-PR0a_mobile_project_setup.html' },
      { trigger: 'Save to intake', route: '/relay?src=client_intake', face: 'F-FU1_mobile_field_updates_review.html' },
    ],
  },
  {
    route: '/clients/:id',
