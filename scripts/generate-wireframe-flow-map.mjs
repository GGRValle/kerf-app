...
function systemContractForFace(id) {
  const exact = {
    ...
    'F-PR0a': ['/projects/new', 'canon_wired', 'operator_confirm', 'Client/project graph creation spine'],
    'F-PR0b': ['/projects/new', 'canon_wired', 'operator_confirm', 'Client/project graph creation spine'],
    ...
    'F-DES1a': ['/design/:projectId', 'canon_wired', 'review_gate', 'Deal -> design -> estimate spine'],
    'F-DS1': ['/design/:projectId', 'canon_wired', 'review_gate', 'Design workspace -> estimate spine'],
    ...
    'F-INV1a': ['/estimate/:projectId/invoice or /projects/:id/money/invoices', 'canon_wired', 'money_guard', 'Estimate line_id -> contract milestone -> invoice spine'],
    'F-INV1b': ['/estimate/:projectId/invoice or /projects/:id/money/invoices', 'canon_wired', 'money_guard', 'Estimate line_id -> contract milestone -> invoice spine'],
    'F-INV2a': ['/estimate/:projectId/invoice/:invoiceId or /money/invoices/:id', 'canon_wired', 'money_guard', 'Contract milestone -> invoice detail -> payment spine'],
    'F-INV2b': ['/estimate/:projectId/invoice/:invoiceId or /money/invoices/:id', 'canon_wired', 'money_guard', 'Contract milestone -> invoice detail -> payment spine'],
    'F-EST1': ['/estimate/:projectId', 'canon_wired', 'operator_confirm', 'Estimate -> proposal -> invoice line_id spine'],
    'F-CHG1': ['/change-orders/new', 'canon_wired', 'operator_confirm', 'Change order -> decision card -> contract adjustment spine'],
    ...
    'F-CL0a': ['/clients/new', 'canon_wired', 'operator_confirm', 'Client graph creation spine'],
    'F-CL0b': ['/clients/new', 'canon_wired', 'operator_confirm', 'Client graph creation spine'],
