...
| `altitude` | W1 skeleton + send-safety | AltitudePacket → DecisionPacket core types plus Policy Gate shell with V1/V2/V6 send-safety, V17 token-budget, and V18 altitude-assignment first cuts. |
