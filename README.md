...
| `altitude` | W1 skeleton + safety validators | AltitudePacket → DecisionPacket core types plus Policy Gate shell with V1/V2/V6 send-safety, V7 source-basis, V8 inference-labeling, V17 token-budget, and V18 altitude-assignment first cuts. |
