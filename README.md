...
| `altitude` | W1 skeleton + safety + learning + audit-trail validators | AltitudePacket → DecisionPacket core types plus Policy Gate shell with V1/V2/V6 send-safety, V7 source-basis, V8 inference-labeling, V9 learning-signal drafts + explicit Blackboard event templates, V12 audit-trail, V17 token-budget, and V18 altitude-assignment first cuts. |
